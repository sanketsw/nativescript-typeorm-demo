...
var Connection = /** @class */ (function () {
    ...
    Connection.prototype.dropDatabase = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var queryRunner, schemas, databases;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        databases = this.entityMetadatas
                            .filter(function (metadata) { return metadata.database; })
                            .map(function (metadata) { return metadata.database; });
                        if (this.driver.database && !databases.find(function (database) { return database === _this.driver.database; }))
                            databases.push(this.driver.database);
                        return [4 /*yield*/, PromiseUtils_1.PromiseUtils.runInSequence(databases, function (database) { return queryRunner.clearDatabase(schemas, database); })];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 5];
