...
export declare class Binary {
     ...
     */
    write(buffer: any | string, offset: number): void;
}
/**
...
export interface ParallelCollectionScanOptions {
    ...
    numCursors?: number;
    /**
     * Return all BSON documents as Raw any documents.
     */
    raw?: boolean;
}
/**
...
export declare class Cursor<T> extends Readable {
     ...
     */
    read(size: number): string | any | void;
    /**
     ...
     */
    unshift(stream: any | string): void;
}
/**
 * Get the count of documents for this cursor.
 * @see http://mongodb.github.io/node-mongodb-native/2.1/api/Cursor.html#count
