...
var SqliteDriver = /** @class */ (function (_super) {
    ...
    SqliteDriver.prototype.loadDependencies = function () {
        try {
            this.sqlite = PlatformTools_1.PlatformTools.load("nativescript-sqlite").verbose();
        }
        catch (e) {
            throw new DriverPackageNotInstalledError_1.DriverPackageNotInstalledError("SQLite", "nativescript-sqlite");
        }
    };
    return SqliteDriver;
