                ...
                switch (_a.label) {
                    case 0:
                        ...
                        addedKeys = metadataPrimaryColumns
                            ...
                            return !table.primaryKeysWithoutGenerated.find(function (dbPrimaryKey) { return dbPrimaryKey.columnName === primaryKey.databaseName; });
                        })
                            .map(function (primaryKey) { return new TablePrimaryKey("", primaryKey.databaseName); });
                        droppedKeys = table.primaryKeysWithoutGenerated.filter(function (primaryKeySchema) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, this.queryRunner.createIndex(tableIndex.tableName, tableIndex)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
